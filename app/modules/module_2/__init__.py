...
# Bu satır, 'app' klasörünün bulunduğu 'Video_Platformu_Yonetim_Sistemi' klasörünü bulur.
...
try:
    ...
    from app.modules.module_2.implementations import StandardVideo, LiveStreamVideo, ShortVideo, VideoService
